 ...
 * Adapted from https://code.makery.ch/library/javafx-tutorial/part6/ with modifications for this app context.
 */
public class WeightStatsWindow extends UiPart<Stage> {
    ...
    public void setWeightData(ObservableList<Day> dayList) {
        ...
        for (int i = 0; i < dayList.size(); i++) {
            series.getData().add(new XYChart.Data<>(dates.get(i), Integer.parseInt(dayList.get(i).getWeight().value)));
        }
