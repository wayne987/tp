...
public class StorageManager implements Storage {
    ...
    @Override
    public Optional<ReadOnlyMyFitnessBuddy> readAddressBook() throws DataConversionException, IOException {
        return readAddressBook(addressBookStorage.getAddressBookFilePath());
    }

    @Override
    public Optional<ReadOnlyMyFitnessBuddy> readAddressBook(Path filePath) throws DataConversionException, IOException {
