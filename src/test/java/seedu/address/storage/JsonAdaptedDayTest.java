...
public class JsonAdaptedDayTest {
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        ...
        JsonAdaptedDay day =
                new JsonAdaptedDay(INVALID_DATE, VALID_WEIGHT, VALID_INPUT, VALID_OUTPUT);
    ...
    public void toModelType_nullDate_throwsIllegalValueException() {
        JsonAdaptedDay day = new JsonAdaptedDay(null, VALID_WEIGHT, VALID_INPUT, VALID_OUTPUT);
    ...
    public void toModelType_invalidWeight_throwsIllegalValueException() {
        JsonAdaptedDay day =
                new JsonAdaptedDay(VALID_DATE, INVALID_WEIGHT, VALID_INPUT, VALID_OUTPUT);
    ...
    public void toModelType_nullWeight_throwsIllegalValueException() {
        JsonAdaptedDay day = new JsonAdaptedDay(VALID_DATE, null, VALID_INPUT, VALID_OUTPUT);
