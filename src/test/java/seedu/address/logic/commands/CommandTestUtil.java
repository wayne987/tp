...
public class CommandTestUtil {
    ...
    public static final String VALID_WEIGHT_AMY = "45";
    public static final String VALID_WEIGHT_BOB = "95";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withWeight(VALID_WEIGHT_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withWeight(VALID_WEIGHT_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        final String[] splitName = day.getName().fullName.split("\\s+");
        model.updateFilteredDayList(new NameContainsKeywordsPredicate(Arrays.asList(splitName[0])));
